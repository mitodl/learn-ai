...
const VideoCntent = () => {
  ...
  const { id: transcriptBlockId, error: transcriptError } = useMemo(() => {
    if (transcriptId.isLoading) return { id: null, error: null }
    if (transcriptId.isError) {
      console.log(transcriptId)
      return { id: null, error: transcriptId.error.message }
    }
        ...
        <Grid container spacing={2} sx={{ padding: 2 }}>
          ...
          >
            ...
            <OpenedxUnitSelectionForm
              ...
              unitLabel="Video"
            />
            {transcriptId.isLoading && <Typography>Loading...</Typography>}
            {transcriptError && (
