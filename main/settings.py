...
AI_DEFAULT_RECOMMENDATION_MAX_TOKENS = get_int(
    "AI_DEFAULT_RECOMMENDATION_MAX_TOKENS", 5000
)
AI_DEFAULT_SUMMARY_MODEL = get_string("AI_DEFAULT_SUMMARY_MODEL", "openai/gpt-4o-mini")
AI_DEFAULT_SYLLABUS_MODEL = get_string("AI_DEFAULT_SYLLABUS_MODEL", AI_DEFAULT_MODEL)
# AI agents that return lengthy contentfile search results need larger token limits
AI_DEFAULT_SYLLABUS_MAX_TOKENS = get_int("AI_DEFAULT_SYLLABUS_MAX_TOKENS", 15000)
...
AI_DEFAULT_VIDEO_GPT_MAX_TOKENS = get_int("AI_DEFAULT_VIDEO_GPT_MAX_TOKENS", 15000)
